...
const SupabaseInspectionRepository_1 = require("../infrastructure/database/repositories/SupabaseInspectionRepository");
const SupabaseUserRepository_1 = require("../infrastructure/database/repositories/SupabaseUserRepository");
...
async function testConnection() {
    ...
    try {
        const inspRepo = new SupabaseInspectionRepository_1.SupabaseInspectionRepository();
        ...
        inspections.forEach((insp, idx) => {
            const location = (0, locations_1.getLocationById)(insp.locationId);
