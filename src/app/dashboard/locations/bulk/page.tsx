...
export default function BulkGeneratePage() {
  ...
  const [preview, setPreview] = useState<
    Array<{ name: string; code: string; floor: string; gender: string; section: string }>
  >([]);
  ...
  const totalCount =
    (config.endFloor - config.startFloor + 1) * config.genders.length * config.sections.length;
        ...
        <div className={styles.formSection}>
          ...
          <div className={styles.formGrid}>
            <div className={styles.formGroup}>
              ...
              <input
                ...
                onChange={(e) =>
                  setConfig({ ...config, startFloor: parseInt(e.target.value) || 1 })
                }
                min="0"
                max="100"
                className={styles.input}
          ...
          <div className={styles.totalCount}>
            ...
            <div className={styles.countDetail}>
              {config.endFloor - config.startFloor + 1} lantai × {config.genders.length} gender ×{' '}
